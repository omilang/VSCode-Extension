...
const GLOBAL_ITEMS = [
  ...
  {
    label: 'print_ret',
    insertText: 'print_ret(${1:value})',
    detail: 'Built-in function',
    documentation: 'Returns a printed string instead of writing directly to output.',
    signature: 'print_ret(value<every>)',
    parameters: ['value<every>'],
  },
  {
    label: 'input',
    ...
    signature: 'input(prompt<every>)',
    parameters: ['prompt<every>'],
  },
  {
    label: 'input_int',
    insertText: 'input_int(${1:prompt})',
    detail: 'Built-in function',
    documentation: 'Reads user input and converts it to a number.',
    signature: 'input_int(prompt<every>)',
    parameters: ['prompt<every>'],
  },
  {
    label: 'len',
  ...
  },
  {
    ...
    signature: 'append(list<list>, value<every>)',
    parameters: ['list<list>', 'value<every>'],
  },
  {
    label: 'pop',
    insertText: 'pop(${1:list}, ${2:index})',
    detail: 'Built-in function',
    documentation: 'Removes an element from a list by index.',
    signature: 'pop(list<list>, index<number>)',
    parameters: ['list<list>', 'index<number>'],
  },
  {
    label: 'extend',
    insertText: 'extend(${1:list}, ${2:other})',
    detail: 'Built-in function',
    documentation: 'Extends one list with another.',
    signature: 'extend(list<list>, other<list>)',
    parameters: ['list<list>', 'other<list>'],
  },
  {
    label: 'clear',
    insertText: 'clear()',
  ...
  },
  {
    ...
    detail: 'Type check',
    documentation: 'Checks whether the value is a list.',
    signature: 'is_list(value<every>)',
    parameters: ['value<every>'],
  },
  {
    label: 'is_dict',
  ...
  },
  {
    ...
    detail: 'Type check',
    documentation: 'Checks whether the value is `null`.',
